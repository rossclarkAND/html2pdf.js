...
/* harmony import */ var _worker_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../worker.js */ "./src/worker.js");
...
var linkInfo = [];
var orig = {
  toContainer: _worker_js__WEBPACK_IMPORTED_MODULE_14__.default.prototype.toContainer,
  toPdf: _worker_js__WEBPACK_IMPORTED_MODULE_14__.default.prototype.toPdf
};

_worker_js__WEBPACK_IMPORTED_MODULE_14__.default.prototype.toContainer = function toContainer() {
  return orig.toContainer.call(this).then(function toContainer_hyperlink() {
    ...
    if (this.opt.enableLinks) {
      ...
      var containerRect = (0,_utils_js__WEBPACK_IMPORTED_MODULE_15__.unitConvert)(container.getBoundingClientRect(), this.prop.pageSize.k);
      ...
      Array.prototype.forEach.call(links, function (link) {
        ...
        for (var i = 0; i < clientRects.length; i++) {
          var clientRect = (0,_utils_js__WEBPACK_IMPORTED_MODULE_15__.unitConvert)(clientRects[i], this.prop.pageSize.k);
...
_worker_js__WEBPACK_IMPORTED_MODULE_14__.default.prototype.toPdf = function toPdf() {
  return orig.toPdf.call(this).then(function toPdf_hyperlink() {
    ...
    if (this.opt.enableLinks) {
      ...
      linkInfo.forEach(function (l) {
        ...
        var url = new URL(l.link.href);
        [["utm_source", "download"], ["utm_medium", "pdf"], ["utm_id", "action_plan"]].forEach(function (_ref) {
